...
const mockVendorProducts = [
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 189,
    image: '/products/ankara-dress.jpg',
    isYouthOwned: true,
    hasGlobalShipping: true,
    isVerified: true,
    badges: ['Best Seller'],
  },
  {
    ...
    rating: 4.7,
    reviews: 156,
    image: '/products/kente-blazer.jpg',
    isYouthOwned: true,
    hasGlobalShipping: true,
    isVerified: true,
  },
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 178,
    image: '/products/scarf-collection.jpg',
    isYouthOwned: true,
    hasGlobalShipping: true,
    isVerified: true,
    badges: ['Limited'],
...
export default function VendorPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <VendorStorefront vendor={mockVendor} products={mockVendorProducts} />
  )
}
